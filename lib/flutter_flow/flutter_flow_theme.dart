...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFF628);
  late Color secondary = const Color(0xFF195C92);
  late Color tertiary = const Color(0xFFFFC000);
  late Color alternate = const Color(0x001A1F24);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFBDBCC0);
  late Color secondaryBackground = const Color(0xFFF2F2F2);
  late Color accent1 = const Color(0xFFFF6699);
  late Color accent2 = const Color(0xFF66CCFF);
  late Color accent3 = const Color(0xFFFF9933);
  late Color accent4 = const Color(0xFF99FF33);
  late Color success = const Color(0xFF00FF00);
  late Color warning = const Color(0xFFFFC000);
  late Color error = const Color(0xFFFF0000);
  late Color info = const Color(0xFF0080FF);
